...
<div class="pop_contact">
  <div class="pop_question">
    <div class="pop_question1"> <span>简单描述您的问题</span> <font>您还可以输入<em>50</em>个字</font> </div>
    <div class="pop_question4">
      <input name="" type="text" class="n_srk2 pop_question2" />
    </div>
    <div class="pop_question3">问题详细描述（选填）：<font>问题描述的越详细，得到的解答也越精准</font></div>
    <div class="pop_question4">
  ...
  <div class="pop_contact1">
    <input name="" type="button" value="" class="pop_submit" />
  </div>
</div>
</body>
</html>
