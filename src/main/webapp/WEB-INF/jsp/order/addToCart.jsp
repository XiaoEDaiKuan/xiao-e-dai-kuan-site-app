...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#pop_login").click(function(){
			tipsWindown("您当前尚未登录，若想申请贷款，请先登录","iframe:iframe:loginForm?productId=${pv.product.id}","450","300","true","","false","text","");
		});
		</c:if>
...
<div class="Fuzzysearch">
	<div class="top Fuzzysearch1">
      ...
      <div class="applicationleft1 ClearFix">
      	...
      	<div class="applicationleft2"><img src="images/products/110x65/${pv.product.icon}" width="110" height="65" /></div>
