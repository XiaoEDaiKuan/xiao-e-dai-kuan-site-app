...
<div id="showdiv">
   ...
   <div id="testdiv">
    ...
    <div class="pop_contact">
       ...
       <div class="pop_city"><a href="#">北京</a><a href="#">上海</a><a href="#">常州</a><a href="#">佛山</a><a href="#">成都</a><a href="#">广州</a><a href="#">南宁</a><a href="#">宁波</a><a href="#">武汉</a><a href="#">青岛</a><a href="#">郑州</a><a href="#">重庆</a><a href="#">石家庄</a><a href="#">洪泽</a><a href="#">贵阳</a><a href="#">攀枝花</a><a href="#">江门</a><a href="#">南海</a></div>
...
<div class="top">
  ...
  <div class="top_right">
    <div class="top_right1"><%=request.getSession().getAttribute("custName") == null ? "游客":request.getSession().getAttribute("custName")%>, 欢迎您！<a href="registered.html">注册</a><font>|</font><a href="loginView">登录</a><font>|</font><a href="members.html">我的会员中心</a><font>|</font><a href="login.html">信贷经理登录</a><font>|</font><a href="manager.html">信贷经理入驻</a></div>
