...
<div class="members clear">
  <div class="members_left font_f">
    ...
    <div class="members_left2">
      <ul>
        ...
        <li><a href="terms.jsp" class="hover2">服务条款</a></li>
  ...
  <div class="financial ground">
    ...
    <div class="fin font_f">
      <p>北京玖富时代投资顾问有限公司依照本服务条款向您提供9F（www…..com）的服务。请您使用9F之前敬请仔细阅本服务条款及法律声明和隐私政策 。通过访问或使用9F，您即明确同意遵守本服务条款以及经参引而并入其中的所有条款、政策以及指南，并受前述规则的约束（"本服务条款"）。如果您不接受本服务条款的全部规定，则请勿使用9F。</p>
